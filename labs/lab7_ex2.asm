...
;Ex 2. Q1. Both memory and register areas were grey out. It looked like the code kept on running. Entering any key from keyboard did not stop 
;until the pause button was hit.

;Ex 2. Q2. R0 and R1 before executing  instruction ‘JSR FACT_SUB_START’ were 0 and 5

;Ex 2. Q3. R0 and R1 after executing  instruction ‘JSR FACT_SUB_START’ were 0 and 4

;Ex 2. Q4. R7 had value x3207 before executing ret

;Ex 2. Q5. The program would never finish and kept on running
